...
namespace PaqueteTuristico.Controllers
{
    ...
    [ApiController]
    public class ProvinceSetController : ControllerBase
    {
        private readonly ProvinceSetService _services;

        public ProvinceSetController(ProvinceSetService _services)
        {
        ...
        {
            var province = await _services.GetProvinceByIdAsync(ProvinceId);
