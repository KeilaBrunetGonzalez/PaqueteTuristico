    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelContract_Hotel_Plan_Seasonid_Hotelid",
                        columns: x => new { x.Seasonid, x.Hotelid },
                        principalTable: "Hotel_Plan",
                        principalColumns: new[] { "HotelId", "SeasonId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrasportWithContractsSet", x => new { x.id, x.Modalityid, x.Vehicleid });
                    table.ForeignKey(
                        name: "FK_TrasportWithContractsSet_TransportSet_Modalityid_Vehicleid",
                        columns: x => new { x.Modalityid, x.Vehicleid },
                        principalTable: "TransportSet",
                        principalColumns: new[] { "ModalityId", "VehicleId" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelContract_Seasonid_Hotelid",
                table: "HotelContract",
                columns: new[] { "Seasonid", "Hotelid" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrasportWithContractsSet_Modalityid_Vehicleid",
